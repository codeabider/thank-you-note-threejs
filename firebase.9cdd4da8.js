...
},{"tslib":"node_modules/tslib/tslib.es6.js","@firebase/util":"node_modules/@firebase/util/dist/index.cjs.js","@firebase/component":"node_modules/@firebase/component/dist/index.cjs.js","@firebase/logger":"node_modules/@firebase/logger/dist/index.esm.js"}],"node_modules/@firebase/auth/dist/auth.js":[function(require,module,exports) {
var global = arguments[3];
...
exports.default = exports.createWebChannelTransport = exports.XhrIo = exports.WebChannel = exports.EventType = exports.ErrorCode = void 0;
...
var t = require("tslib"),
    ...
    n = require("@firebase/logger"),
    r = require("@firebase/util"),
    i = require("@firebase/webchannel-wrapper"),
...
function Sr(t) {
  ...
  return void 0 !== t.query.documents ? (y(1 === (n = t.query).documents.length), e = pn(hn(ie(n.documents[0])))) : e = function (t) {
    ...
    n.limit && (a = function (t) {
      var e;
      return C(e = "object" == _typeof(t) ? t.value : t) ? null : e;
    }(n.limit));
    var c = null;
...
function () {
  ...
  return t.Du = function (e, n) {
    for (var r = JSON.parse(n), i = "object" == _typeof(r) && r.activeTargetIds instanceof Array, o = lt(), s = 0; i && s < r.activeTargetIds.length; ++s) {
...
function Ho(t, e, n, r) {
  if (!("object" === e ? Ko(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : _typeof(r) === e)) {
    var i = Yo(r);
...
function Ls(t) {
  return !("object" != _typeof(t) || null === t || t instanceof Array || t instanceof Date || t instanceof k || t instanceof gs || t instanceof is || t instanceof ws || t instanceof as);
}
    ...
    this.sd = e, void 0 !== e.credentials && (this.nd = function (t) {
      ...
      switch (t.type) {
        case "gapi":
          ...
          return y(!("object" != _typeof(e) || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), new Ci(e, t.zh || "0");
  ...
  return t.__extends(n, e), n._d = function (t, e, r) {
    ...
    var s = {
      includeMetadataChanges: !1
        ...
        u = 0;
    "object" != _typeof(i[u]) || Vo(i[u]) || (Xo("DocumentReference.onSnapshot", s = i[u], ["includeMetadataChanges"]), zo("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), u++);
    var a = {
  ...
  e.prototype.yd = function (e, n, r, i) {
    ...
    return function (t, e, n, r, i, o) {
      ...
      for (var u = [], a = 0; a < i.length; a++) {
        ...
        if (s[a].field.M()) {
          if ("string" != typeof c) throw new x(D.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + _typeof(c));
    ...
    if ("object" != _typeof(i[u]) || Vo(i[u]) || (Xo("Query.onSnapshot", s = i[u], ["includeMetadataChanges"]), zo("Query.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), u++), Vo(i[u])) {
      var a = i[u];
...
},{"@firebase/firestore":"node_modules/@firebase/firestore/dist/index.cjs.js"}],"node_modules/firebase/app/dist/index.cjs.js":[function(require,module,exports) {
'use strict';
...
},{"@firebase/app":"node_modules/@firebase/app/dist/index.cjs.js"}],"src/firebase.js":[function(require,module,exports) {
"use strict";
...
// rollup bundle issue with ESM import
var firebaseConfig = {
...
exports.db = db;
},{"firebase/auth":"node_modules/firebase/auth/dist/index.esm.js","firebase/firestore":"node_modules/firebase/firestore/dist/index.esm.js","firebase/app":"node_modules/firebase/app/dist/index.cjs.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/firebase.js"], null)
//# sourceMappingURL=/firebase.9cdd4da8.js.map